...
""
function constraint_active_load_gen_aggregation_sheddable(pm::GenericPowerModel, n::Int, i::Int, bus_gens, bus_loads)
    pnode = PowerModels.var(pm, n, :pnode)[i]
    pg = PowerModels.var(pm, n, :pg)
...
function constraint_reactive_load_gen_aggregation_sheddable(pm::GenericPowerModel, n::Int, i::Int, bus_gens, bus_loads)
    qnode = PowerModels.var(pm, n, :qnode)[i]
    qg = PowerModels.var(pm, n, :qg)
